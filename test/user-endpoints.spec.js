    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "traurig", translation: "sad" },
            { original: "hallo", translation: "hello" },
            { original: "morgen", translation: "tomorrow" },
            { original: "schon", translation: "beautiful" },
            { original: "nett", translation: "nice" },
            { original: "komisch", translation: "funny" },
            { original: "lachen", translation: "laugh" },
            { original: "hassen", translation: "hate" },
          ],
        };
        return supertest(app)
          .post("/api/user")
